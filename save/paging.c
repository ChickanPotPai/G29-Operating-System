...
paging_init()
{
	...
	for (asdf = 0; asdf < MAX_PROGS; asdf++)
	{
		for (i = KB4; i < MB4; i += KB4)	// page 0mb-4mb in 4kb pieces
		{
			page_4kb((void*)i, (void*)i, asdf);
		}

		page_4mb((void*)MB4, (void*)MB4, asdf);		// page 4mb-8mb as one directory 
	}
...
*	Inputs: process id
*	Return: void
*	Function to switch cr3 to hold the current program's respective
